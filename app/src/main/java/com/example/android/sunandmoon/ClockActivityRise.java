...
public class ClockActivityRise extends View {

    public static boolean is24;
    public static boolean hourOnTop;
    private final ArrayList<DialOverlayRise> mDialOverlay = new ArrayList<DialOverlayRise>();
    ...
    private HandsOverlayRise mHandsOverlay;
    ...
    public ClockActivityRise(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context, R.drawable.default_face1, R.drawable.default_hour1, R.drawable.default_minute, 0, false, false);
    }

    public ClockActivityRise(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, R.drawable.default_face1, R.drawable.default_hour1, R.drawable.default_minute, 0, false, false);
    }

    public ClockActivityRise(Context context) {
        super(context);
        init(context, R.drawable.default_face1, R.drawable.default_hour1, R.drawable.default_minute, 0, false, false);
    }
    ...
    public void init(Context context, @DrawableRes int watchFace, @DrawableRes int hourHand, @DrawableRes int minuteHand, int alpha, boolean is24, boolean hourOnTop) {
        ...
        ClockActivityRise.hourOnTop = hourOnTop;
        setFace(watchFace);
        ...
        mHandsOverlay = new HandsOverlayRise(Hhand, Mhand);
    }
    ...
    public void setHandsOverlay(HandsOverlayRise handsOverlay) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (final DialOverlayRise overlay : mDialOverlay) {
    ...
    public void addDialOverlay(DialOverlayRise dialOverlay) {
        mDialOverlay.add(dialOverlay);
    }

    public void removeDialOverlay(DialOverlayRise dialOverlay) {
